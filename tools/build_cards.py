...
OUTS = {
    ...
    "daeasy": card(
        "daeasy", "#60a5fa", "DAEASY", "회사 공식 사이트 전체 — 공개 사이트 · 고객 회원 · 어드민 · 콘텐츠 자동 발행",
        "운영 중", "daeasy.co.kr", "4", "영역 · 고객 인증(캡차·이메일) · 역할 기반 어드민 · 자동 발행 2종",
        "케이브레인컴퍼니 · 2026.05 ~ 운영 중 · 요구분석 · 설계 · 개발 · 운영 · RLS · rate limit · ISR"),
    "agent-pipeline": card(
