...
OUTS = {
    ...
    "daeasy": card(
        "daeasy", "#60a5fa", "DAEASY", "회사 사이트와 인사이트 자동 발행 파이프라인",
    ...
    "nolai": card(
        "nolai", "#f472b6", "AI쏙", "어린이가 임베딩 · 토큰 · 픽셀 같은 AI 원리를 손으로 만지며 배우는 웹",
        "개발 중", "nolai", "10~13", "세 대상 · 배포 준비 중",
        "개인 프로젝트 · 2026.08 ~", inner=nolai_inner("#f472b6")),
}
